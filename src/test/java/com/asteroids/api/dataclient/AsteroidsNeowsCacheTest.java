...
class AsteroidsNeowsCacheTest {
  ...
  @Mock private AsteroidsNeowsClient asteroidsNeowsClient;
  ...
  @Test
  void getAsteroids_shouldCallClientOnlyOnce_ifMultipleRequestsMadeBeforeCacheExpires()
      throws JsonProcessingException {
    when(asteroidsNeowsClient.getAsteroids(anyString(), anyString()))
        .thenReturn(mapper.readTree(EXPECTED_JSON_STRING));
